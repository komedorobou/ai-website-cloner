...
function CountUpStat({ num, unit, label, desc }: { num: number; unit: string; label: string; desc: string }) {
  ...
  return (
    <div ref={ref} className="text-center group">
      <p className={`text-[56px] md:text-[80px] lg:text-[96px] font-bold tracking-[-0.04em] text-[#1F49B5] transition-all duration-700 ${gothic}`}>
        {count}<span className="text-[#6B8FE3] font-light">{unit}</span>
      </p>
      <div className="w-12 h-[2px] bg-gradient-to-r from-[#1F49B5]/0 via-[#1F49B5]/40 to-[#1F49B5]/0 mx-auto mt-4 mb-3 group-hover:w-20 transition-all duration-700" />
...
export default function Home() {
  ...
  return (
    <main className={`bg-[${colors.bg}] text-[${colors.text}] overflow-hidden ${gothic}`}>
      ...
      {/* ===== NAV ===== */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#1F49B5] backdrop-blur-md border-b border-white/20 shadow-[0_1px_0_rgba(255,255,255,0.1)]">
      ...
      >
        <div className="h-full flex flex-col justify-center px-8">
          ...
          <a
            href="#contact"
            onClick={() => setMobileMenuOpen(false)}
            className={`mt-12 inline-flex items-center justify-center gap-3 text-[13px] font-semibold tracking-[0.06em] bg-[#1F49B5] text-white px-8 py-5 transition-all duration-500 ${
      ...
      <section className="h-[100svh] relative">
        ...
        <div className="absolute inset-0 z-10 flex flex-col justify-end pb-16 md:pb-24 px-6 md:px-12">
          <div className="max-w-[1400px] mx-auto w-full">
            <ScrollReveal duration={1.2} delay={0.3}>
              <p className="text-[11px] tracking-[0.5em] uppercase text-[#6B8FE3] mb-5 md:mb-6 font-medium">
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10">
          <ScrollReveal delay={1.5}>
            <div className="w-px h-12 bg-gradient-to-b from-[#6B8FE3]/50 to-transparent" />
          </ScrollReveal>
        </div>
      </section>
      ...
      <section id="about" className="py-28 md:py-44 bg-[#F6FAFA]">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          <ScrollReveal>
            <p className="text-[11px] tracking-[0.3em] uppercase text-[#1F49B5] mb-12 md:mb-16 font-semibold">About Us</p>
          </ScrollReveal>
          ...
          <div className="grid md:grid-cols-[1.2fr_1fr] gap-12 md:gap-20 items-start">
            ...
            <div className="flex flex-col gap-6 md:pt-4">
              ...
              <ScrollReveal delay={0.3}>
                <p className="text-[14px] md:text-[15px] text-[#5A7070] leading-[2.3] font-light">
                  近年は<strong className="text-[#1F49B5] font-semibold">自分史</strong>や<strong className="text-[#1F49B5] font-semibold">終活整理</strong>のための冊子制作に力を入れ、人生の記憶を美しい一冊にまとめるお手伝いをしています。デザインから印刷・製本まで、プロフェッショナルが一貫体制でお届けします。
                </p>
              </ScrollReveal>
            </div>
          </div>
          ...
          {/* 数字 */}
          <div className="mt-20 md:mt-28 pt-12 border-t border-[#1F49B5]/10">
      ...
      <section id="services" className="py-28 md:py-44 bg-[#F6FAFA]">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          <ScrollReveal>
            <p className="text-[11px] tracking-[0.3em] uppercase text-[#1F49B5] mb-4 font-semibold">Services</p>
          </ScrollReveal>
          <ScrollReveal delay={0.1}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              <ScrollReveal key={service.tag} delay={i * 0.06}>
                <div className="bg-white border border-[#1F49B5]/[0.06] p-8 md:p-10 group hover:border-[#1F49B5]/15 hover:shadow-[0_8px_40px_rgba(31,73,181,0.06)] transition-all duration-700 h-full flex flex-col">
                  {"img" in service && service.img ? (
                    ...
                    <>
                      <p className="text-[10px] tracking-[0.25em] uppercase text-[#1F49B5] mb-6 font-semibold">{service.tag}</p>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {service.items.map((item) => (
                          <span key={item} className="text-[10px] bg-[#E0F4F4] text-[#1F49B5] px-3 py-1 font-medium tracking-[0.02em]">
                            {item}
                          </span>
                        ))}
                      </div>
            ...
            <div>
              <ScrollReveal>
                <div className="flex items-center gap-3 mb-4">
                  <p className="text-[11px] tracking-[0.3em] uppercase text-[#6B8FE3] font-semibold">New Service</p>
                  <span className="text-[10px] bg-[#1F49B5] text-white px-3 py-1 font-semibold tracking-[0.1em] uppercase">New</span>
                </div>
              </ScrollReveal>
              <ScrollReveal delay={0.1}>
                ...
                <div className="flex flex-col gap-4">
                  {[
                    ...
                    <div key={point} className="flex items-center gap-3">
                      <span className="w-1.5 h-1.5 bg-[#6B8FE3] rounded-full flex-shrink-0" />
              ...
              <ScrollReveal delay={0.4}>
                <a href="/pocket" className={`inline-flex items-center gap-3 text-[13px] font-semibold tracking-[0.06em] bg-[#1F49B5] text-white px-8 py-4 mt-10 hover:bg-[#6B8FE3] transition-all duration-500`}>
                  POCKETについて詳しく見る
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
                </a>
              </ScrollReveal>
      ...
      <section className="py-28 md:py-44 bg-[#061818]">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
            <div>
              <ScrollReveal>
                <p className="text-[11px] tracking-[0.3em] uppercase text-[#6B8FE3] mb-4 font-semibold">Featured</p>
              </ScrollReveal>
              <ScrollReveal delay={0.1}>
      ...
      <section id="workflow" className="py-28 md:py-44 bg-[#F6FAFA]">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 mb-16">
          <ScrollReveal>
            <p className="text-[11px] tracking-[0.3em] uppercase text-[#1F49B5] mb-4 font-semibold">Workflow</p>
          </ScrollReveal>
          <ScrollReveal delay={0.1}>
            <h2 className={`text-[32px] md:text-[48px] lg:text-[64px] leading-[1.2] tracking-[-0.02em] font-bold ${gothic}`}>
              ご利用の流れ。
            ...
            <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
              <div className="relative aspect-[4/3] md:aspect-square overflow-hidden bg-[#0B3838]">
                ...
                <div className="absolute bottom-6 left-6">
                  <span className="text-[10px] tracking-[0.3em] uppercase text-[#6B8FE3] font-semibold">
                ...
                {workflowSteps.map((step, i) => (
                  <div
                    ...
                    className={`border-l-[2px] pl-6 md:pl-8 py-3 transition-all duration-700 cursor-pointer ${
                      workflowStep === i
                        ? "border-[#1F49B5] opacity-100"
                        : "border-[#1F49B5]/10 opacity-25"
                    }`}
                  >
                    <div className="flex items-baseline gap-3 mb-1">
                      <span className="text-[10px] tracking-[0.15em] text-[#1F49B5] font-bold">{step.num}</span>
      ...
      <section id="pricing" className="py-28 md:py-44 bg-[#F6FAFA]">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          <ScrollReveal>
            <p className="text-[11px] tracking-[0.3em] uppercase text-[#1F49B5] mb-4 font-semibold">Pricing</p>
          </ScrollReveal>
          <ScrollReveal delay={0.1}>
            <h2 className={`text-[32px] md:text-[48px] lg:text-[64px] leading-[1.2] tracking-[-0.02em] mb-6 font-bold ${gothic}`}>
              参考価格
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <ScrollReveal key={item.title} delay={i * 0.08}>
                <div className="bg-white border border-[#1F49B5]/[0.06] p-10 text-center hover:border-[#1F49B5]/15 hover:shadow-[0_8px_40px_rgba(31,73,181,0.06)] transition-all duration-700">
                  <h3 className={`text-[18px] font-bold mb-3 ${gothic}`}>{item.title}</h3>
                  <p className="text-[20px] md:text-[24px] font-bold text-[#1F49B5] mb-4">{item.price}</p>
      ...
      <section className="py-28 md:py-44 bg-white">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          <ScrollReveal>
            <p className="text-[11px] tracking-[0.3em] uppercase text-[#1F49B5] mb-4 font-semibold">Company</p>
          </ScrollReveal>
          <ScrollReveal delay={0.1}>
          ...
          <div className="max-w-[800px]">
            <StaggerContainer stagger={0.04}>
              {[
                ...
                <div key={row.label} className="flex flex-col md:flex-row md:items-baseline py-5 border-b border-[#1F49B5]/6">
                  <span className="text-[11px] tracking-[0.12em] text-[#1F49B5] md:w-[160px] mb-1 md:mb-0 font-semibold flex-shrink-0">{row.label}</span>
      ...
      <section id="access" className="py-28 md:py-44 bg-[#F6FAFA]">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          <ScrollReveal>
            <p className="text-[11px] tracking-[0.3em] uppercase text-[#1F49B5] mb-4 font-semibold">Access</p>
          </ScrollReveal>
          <ScrollReveal delay={0.1}>
            <h2 className={`text-[32px] md:text-[48px] leading-[1.2] tracking-[-0.02em] mb-16 font-bold ${gothic}`}>
              アクセス
          ...
          <div className="grid md:grid-cols-[1.3fr_1fr] gap-8 md:gap-16">
            ...
            <div className="flex flex-col gap-6">
              <ScrollReveal delay={0.2}>
                <div className="bg-white border border-[#1F49B5]/[0.06] p-8">
                  <p className="text-[11px] tracking-[0.15em] text-[#1F49B5] mb-3 font-semibold">所在地</p>
              ...
              <ScrollReveal delay={0.25}>
                <div className="bg-white border border-[#1F49B5]/[0.06] p-8">
                  <p className="text-[11px] tracking-[0.15em] text-[#1F49B5] mb-3 font-semibold">お電話でのお問い合わせ</p>
                  <p className="text-[14px] text-[#5A7070] leading-[2] font-light">
                    TEL: <a href="tel:0725452360" className="text-[#1F49B5] font-semibold hover:underline">0725-45-2360</a><br />
                    FAX: 0725-45-7684
                  </p>
                </div>
              </ScrollReveal>
              <ScrollReveal delay={0.3}>
                <div className="bg-white border border-[#1F49B5]/[0.06] p-8">
                  <p className="text-[11px] tracking-[0.15em] text-[#1F49B5] mb-3 font-semibold">営業時間</p>
                  <p className="text-[14px] text-[#5A7070] leading-[2] font-light">
                    9:00〜17:00（土日祝休）
                  </p>
                </div>
              ...
              <ScrollReveal delay={0.35}>
                <div className="bg-white border border-[#1F49B5]/[0.06] p-8">
                  <p className="text-[11px] tracking-[0.15em] text-[#1F49B5] mb-3 font-semibold">データ入稿</p>
                  <p className="text-[14px] text-[#5A7070] leading-[2] font-light">
      ...
      <section id="contact" className="py-28 md:py-44 bg-[#061818]">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          <div className="grid md:grid-cols-[1fr_1.3fr] gap-12 md:gap-20">
            <div>
              <ScrollReveal>
                <p className="text-[11px] tracking-[0.3em] uppercase text-[#6B8FE3] mb-4 font-semibold">Contact</p>
              </ScrollReveal>
              <ScrollReveal delay={0.1}>
              ...
              <ScrollReveal delay={0.3}>
                <div className="flex flex-col gap-6">
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 bg-[#1F49B5]/20 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#6B8FE3" strokeWidth="1.5"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                    </div>
                    <div>
                      <p className="text-[10px] tracking-[0.1em] text-white/30 mb-1 font-semibold uppercase">電話番号</p>
                      <a href="tel:0725452360" className="text-[15px] text-[#6B8FE3] font-medium">0725-45-2360</a>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 bg-[#1F49B5]/20 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#6B8FE3" strokeWidth="1.5"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
                    </div>
                    <div>
                      <p className="text-[10px] tracking-[0.1em] text-white/30 mb-1 font-semibold uppercase">メール</p>
                      <a href="mailto:info@izumi-syuppan.co.jp" className="text-[15px] text-[#6B8FE3] font-medium">info@izumi-syuppan.co.jp</a>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 bg-[#1F49B5]/20 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#6B8FE3" strokeWidth="1.5"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                    </div>
                    <div>
                ...
                <form onSubmit={handleContactSubmit}>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                      ...
                      <input name="company" type="text" placeholder="株式会社○○" className="w-full bg-white/[0.06] border border-white/[0.1] px-4 py-3 text-[14px] text-white placeholder:text-white/20 outline-none focus:border-[#1F49B5] transition-colors font-light" />
                    </div>
                    <div>
                      <label className="text-[11px] text-white/50 mb-2 block font-medium">お名前 <span className="text-[#C4943A]">*</span></label>
                      <input name="name" type="text" placeholder="山田 太郎" required className="w-full bg-white/[0.06] border border-white/[0.1] px-4 py-3 text-[14px] text-white placeholder:text-white/20 outline-none focus:border-[#1F49B5] transition-colors font-light" />
                    </div>
                  </div>

                  <div className="mb-4">
                    <label className="text-[11px] text-white/50 mb-2 block font-medium">メールアドレス <span className="text-[#C4943A]">*</span></label>
                    <input name="email" type="email" placeholder="info@example.com" required className="w-full bg-white/[0.06] border border-white/[0.1] px-4 py-3 text-[14px] text-white placeholder:text-white/20 outline-none focus:border-[#1F49B5] transition-colors font-light" />
                  </div>
                    ...
                    <>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                          ...
                          <select name="printType" className="w-full bg-white/[0.06] border border-white/[0.1] px-4 py-3 text-[14px] text-white/60 outline-none focus:border-[#1F49B5] transition-colors appearance-none font-light">
                        ...
                        <div>
                          ...
                          <input name="quantity" type="text" placeholder="例：100部" className="w-full bg-white/[0.06] border border-white/[0.1] px-4 py-3 text-[14px] text-white placeholder:text-white/20 outline-none focus:border-[#1F49B5] transition-colors font-light" />
                        </div>
                      </div>
                      <div className="mb-4">
                        <label className="text-[11px] text-white/50 mb-2 block font-medium">希望納期</label>
                        <input name="deadline" type="text" placeholder="例：2週間後、○月○日まで" className="w-full bg-white/[0.06] border border-white/[0.1] px-4 py-3 text-[14px] text-white placeholder:text-white/20 outline-none focus:border-[#1F49B5] transition-colors font-light" />
                      </div>
                    </>
                  )}
                  ...
                  <div className="mb-6">
                    ...
                    <textarea name="message" placeholder="ご相談内容やご質問をご記入ください" required rows={5} className="w-full bg-white/[0.06] border border-white/[0.1] px-4 py-3 text-[14px] text-white placeholder:text-white/20 outline-none focus:border-[#1F49B5] transition-colors resize-y font-light" />
                  </div>

                  <button type="submit" className="w-full bg-[#1F49B5] text-white py-4 text-[14px] font-semibold tracking-[0.06em] hover:bg-[#6B8FE3] transition-all duration-500 flex items-center justify-center gap-3">
                    送信する
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg>
                  </button>
                  {formSent && (
                    <p className="mt-4 text-center text-[12px] text-[#6B8FE3] font-medium">
